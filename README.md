...
***(A)** [Petteri Teikari (2012) PhD thesis](https://tel.archives-ouvertes.fr/file/index/docid/999326/filename/TH2012_Teikari_Petteri_ii.pdf) discussion, **(B)** SORAA healthy marketing material with the violet-pumped white LED, **(C)** Nichia's alternative to SORAA Zeroblue line. Along with the advertised "circadian protection", the violet-pumped LEDs give broader light spectrum, thus better color rendering as well*
